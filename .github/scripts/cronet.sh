...
function fetch_version() {
    # 获取最新cronet版本
    lastest_cronet_version=`curl -s "https://chromiumdash.appspot.com/fetch_releases?channel=$branch&platform=Android&num=2&offset=$offset" | jq .[].version -r | sort -rV | head -n 1`
