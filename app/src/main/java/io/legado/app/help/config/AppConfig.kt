...
object AppConfig : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private fun getPrefUserAgent(): String {
        ...
        if (ua.isNullOrBlank()) {
            return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${org.chromium.net.impl.ImplVersion.getCronetVersion()} Safari/537.36"
        }
        return ua
    }
